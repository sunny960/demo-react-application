        ...
        <LeftContainer>
            <ContentContainer>
                ...
                <SocialIconContainer>
                    ...
                    <SocialIcon src={'/images/team_facebook_icon.jpg'} onClick={()=>window.open('https://www.facebook.com/narendramodi/', '_blank')}/>
                    <SocialIcon src={'/images/team_instagram_icon.jpg'} onClick={()=>window.open('https://www.instagram.com/narendramodi/?hl=en', '_blank')}/>
                </SocialIconContainer>
            </ContentContainer>
        </LeftContainer>
        <RightContainer>
